...
As a customer I want to call a travel company consultant so that I can discuss my chosen destination. | High | 5 | Customer is able to call a consultant through the travel company website system.
...
As a customer, I want to register to the company website so that I can create a personalised account with my saved preferred destinations | Medium | 5 | Customers will be able to create an account for the website where they can saved their prefered travel destinations and customise what they see on the website. 

## Competitive Advantages of the new Information System Project
The call flow between RM's and customers will greatly improve after implementing this this new IS system because now the profile specialists will effectively match the customers with RM's in respect to RM's skills and knowledge and customer's specific interest in the holiday package. This will ultimately lead to increased sales for travel agency as RM's will have higher chances of converting potential custoemrs into sales as they will focus on specific customer issues in selecting holiday package and thus try to connect more with clients.

RM's will be benefitting from this system most because now they can be more prepared to answer customer queries in more effective and efficient manner to their own best knowledge and ability due to profile matching method used by the new system. With help of profile specialists matching the customer and RM, it is less likely for a RM to get customers with issues which is not in their area of expertise and knwoledge. When Customer issues are solved by a RM, then customer would be redirected to appropriate RM who can solve their issues.

Customers are the ones who are most likely to benefit from this new IS as they will be able to match with the RM who can relate and empathize with their situation and provide substantial insights into their problems thus giving customers better understanding and guidance in selecting the best holiday package. Only those RM's with more experience with customer's interest specific holiday package will be assigned to them so that the RM can go through the holiday package in a way which a customer can understand in a thorough manner.

## Possible adverse effects of the new Information System Project
...
A possible adverse effect the new system could bring to the company is a larger influx of customer calls, while this may sound like a possible benefit a larger customer input could result in increased wait times and queues for customers due to the lack of relationship managers the company can provide. While one of the aims of this software development is to reduce the queues and waiting times customers experience, this possible risk would only add to the current issues of the business rather than solving it. Thereby, cuasing reduce sales and decreased customer satisfaction.

Another possible adverse effect the system may have on the Travel agency may be the inaccurate pairing of the customers to a corresponding relationship manager with similar profile attributes. Eloborating on this impact, customers who look to consult a relationship manager with high expertise in a chosen destination, only to be paired with a relationship manager with little knowledge could result in a decrease of sales. Although, ensuring a customer is paired with a relationship manager with a similar profile score is a key aspect of the system, it may cause customers to lose trust in the company gain a sense of inappropriate racial profiling as a means of increasing company sales.
